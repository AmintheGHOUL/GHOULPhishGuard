      ...
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 flex gap-3">
        ...
        <div className="text-sm text-blue-900 dark:text-blue-200 space-y-2">
          <p className="text-xs opacity-90">
            This public version showcases the Phish-Guard interface. Find the source code on <a href="https://github.com/AmintheGHOUL" target="_blank" rel="noopener noreferrer" className="font-medium underline hover:opacity-75 transition-opacity">GitHub</a>.
          </p>
        </div>
      </div>
